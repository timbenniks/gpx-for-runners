	...
	var GPX = function () {
	  ...
	  function GPX(gpxContent) {
	    ...
	    try {
	      ...
	      var XMLDOMParser = __webpack_require__(1).DOMParser;
	  ...
	  _createClass(GPX, [{
	    ...
	    key: 'getAverageElevation',
	    value: function getAverageElevation() {
	      var elevation = 0,
	          devideBy = 0;
	    ...
	    key: 'pace',
	    value: function pace() {
	      var duration = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.duration().totalMS;
...
/***/ function(module, exports, __webpack_require__) {
	...
	//if(typeof require == 'function'){
		var XMLReader = __webpack_require__(2).XMLReader;
